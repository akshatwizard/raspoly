      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12">
            <h5>Polypropylene Multifilament Yarns</h5>
            <p>
              <img
                ...
                className="mb-3"
              />
              Our polypropylene multifilament yarns, available in high and
              medium tenacity, come in three types: intermingled, twisted, and
              cabled, with a denier range from 300 to 5000.
            </p>
            <h5>Uses & Functions</h5>
            <p>
              PP yarns serve as the ideal starting material for weaving,
              braiding, twisting, and sewing.
            </p>
            <h5>Features & Benefits</h5>
            <p>
              Our PP yarns are available in various colors, including natural,
              black, and blue, with additional colors upon request. They boast
              excellent technical properties, including high tenacity, chemical
              resistance, and flexibility. Precision winding is offered for
              coarse yarns, while high-quality twisting ensures smooth
              performance during sewing.
            </p>
            <h5>Applications</h5>
            <p>
              Common applications include sewing, slings, industrial use,
              braided ropes, webbing, nets, belts, and filtration.
            </p>
            <h5>Seam Variants</h5>
            <p>
              Available seam options include single chain, Heracles (overlock),
              double chain stitch, and Heracles (overlock) + chain stitch
              (safety stitch). The specific seam type is determined during
              production based on the capacity of the big bag.
            </p>
            <br />
            <br />
