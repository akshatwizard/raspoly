        ...
        <div className="row">
          <div className="col-12 col-lg-8 col-md-5 d-flex justify-content-center align-items-center">
            <p>
              ...
              gusseted bag and a stand up pouch, and rolls it into a package
              that sits narrow on the shelf, doesn’t tip over and squares up
              like a box. These bags are generally used for cement, resin and
