        ...
        <div className="row">
            <div className="col-12">
                ...
                <p>
                    ...
                    Polypropylene Multifilament Yarns of high and medium tenacity. They come in three different types (Intermingled, Twisted, Cabled), with a wide denier range varying from 300 to 5000.
                </p>
                <h3>Uses & Functions</h3>
                <p>PP Yarns are the ideal starting material for weaving, braiding, twisting and sewing.</p>
                <h4>Features & Benefits</h4>
                <p>The wide range of our PP Yarns includes natural, black, blue and a variety of colours, upon request. They all offer excellent technical parameters, with high tenacity, chemical resistance and flexibility. Precision winding is available for coarse yarns. High quality twisting ensures a smooth performance during sewing.
                </p>
                <h4>Applications</h4>
